...
dot_data = tree.export_graphviz(model, out_file=None, class_names=['hitam01','hitam02','hitam03','hitam04','hitam05','hitam06','hitam07'])
graph = graphviz.Source(dot_data)    
graph.render("dt109_sung_maxdepth6")
